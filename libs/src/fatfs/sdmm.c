...
#define DO			(0x01 &	0x01)	/* Test for MMC DO ('H':true, 'L':false) */

#define DI_INIT()	(0x01 &	0x01)	/* Initialize port for MMC DI as output */
#define DI_H()		(0x01 &	0x01)	/* Set MMC DI "high" */
#define DI_L()		(0x01 &	0x01)	/* Set MMC DI "low" */

#define CK_INIT()	(0x01 &	0x01)	/* Initialize port for MMC SCLK as output */
#define CK_H()		(0x01 &	0x01)	/* Set MMC SCLK "high" */
